...
//     //         </tbody>
//     //     </table>
//     //     <div style="padding-bottom: 15px;"><span style="font-weight: bold;">Tổng tiền:&nbsp;</span><span><b>${order.totalAmount.toLocaleString()}đ</b></span></div>
//     // `;
//     // }
//     renderOrderDetail(order) {
//         const detailSection = document.getElementById('listDetailOrderHistory');
...
//         // Kiểm tra trạng thái của đơn hàng dựa trên giá trị isIssue
//         if (isIssue) {
//             return 'Đã xuất kho'; // Trạng thái nếu isIssue là true
//         } else {
//             return 'Chưa xuất kho'; // Trạng thái nếu isIssue là false
//         }
//     }
// }
