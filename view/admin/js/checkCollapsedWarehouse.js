document.addEventListener('DOMContentLoaded', () => {
    ...
    const detailInvoiceImportHref = document.getElementById('detailInvoiceImportHref');
    ...
    const HREF = [statisticWarehouseHref, supplierHref, warehouseHref, issueHref, invoiceImportHref, detailInvoiceImportHref, invoiceExportHref] ;
